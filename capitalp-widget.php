...
class CapitalP_Quote_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array(
			'classname'   => 'capitalp-widget',
			'description' => __( 'Retrieve quote from capitalp.org', 'capitalp-widget' )
		);
		$control_ops = array( );
		parent::__construct( 'capitalp', __( 'CapitalP.org Quote', 'capitalp-widget' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$hide_citation = $instance['hide_citation'];
		?>
		<p>
